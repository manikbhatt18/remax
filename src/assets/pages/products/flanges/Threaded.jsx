      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Threaded Flange</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Threaded Flange</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {[
                { title: "No welding required connection", desc: "Attaches to the pipe without welding, ideal for areas where welding is hazardous." },
                { title: "Ideal for small pipe sizes", desc: "Commonly used for small diameter pipes and low pressure applications." },
                { title: "Threaded joint for easy installation", desc: "Simple screw mechanism allows for quick assembly and disassembly." }
              ].map((feature, idx) => (
          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <p>
                  A threaded flange or fitting is not suitable for a pipe system with thin wall thickness, because cutting thread on a pipe is not possible. Thus, thicker wall thickness must be chosen. ASME B31.3 Piping Guide says: Where steel pipe is threaded and used for steam service above 250 psi or for water service above 100 psi with water temperatures above 220° F, the pipe shall be seamless and have a thickness at least equal to schedule 80 of ASME B36.10.
                </p>
              </div>
            )}
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left border-collapse">
                    <tbody>
                      {[
                        { label: "Type", value: "Threaded Flange" },
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto rounded-lg border border-slate-200">
                  <table className="w-full text-sm text-left">
                    ...
                    <tbody>
                      {[
                        { type: "Carbon Steel Threaded Flanges", grades: "ASTM A105/A105N, A350 LF1, LF2 CL1/CL2, LF3 CL1/CL2, A694 F42, F46, F48, F50, F52, F56, F60, F65, F70, A516.60, 65, 70, Steel RST37.2, C22.8" },
                        { type: "Stainless Steel Threaded Flanges", grades: "ASTM A182 F202, F304/304L/304H, F316/316L, F316H, F316TI, F310, F321, F904L" },
                        { type: "Alloy Steel Threaded Flanges", grades: "ASTM A182 F1, F5, F9, F11, F22, F91" },
                        { type: "Special Alloy Threaded Flanges", grades: "Duplex, Super Duplex, Nickel Alloys" },
