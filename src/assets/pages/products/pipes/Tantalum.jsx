...
const Tantalum = () => {
  ...
  const tabs = [
    ...
    // Tantalum doc section d ends with composition, no properties listed in source.
  ];
      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Tantalum Pipe</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Tantalum Pipe</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {[
                { title: "Exceptional chemical resistance", desc: "Chemical inertness makes it valuable for laboratory equipment and severe corrosive media." },
                { title: "High purity metal piping", desc: "Available in high purity grades for specialized applications." },
                { title: "For severe corrosive media", desc: "A substitute for platinum in aggressive chemical environments." }
              ].map((feature, idx) => (
          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500">
                <p>
                  REMAX FORGE & FITTINGS are among the pre-eminent organizations, involved in manufacturers, suppliers, stockists and exporter Tantalum Pipe. Available in different lengths, thicknesses and sizes, these Tantalum Pipe are widely demanded by various industries like food & beverage, chemical, petrochemical, pharmaceutical and cosmetics. In addition to this, we provide tailor-made solution for all our offered Tantalum Pipe as per customers’ requirements.
                </p>
