      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Incoloy Pipes</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Incoloy Pipes</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {[
                { title: "High temperature strength alloy", desc: "Designed to maintain high strength even at elevated temperatures." },
                { title: "Resistant to oxidation", desc: "Provides excellent resistance to oxidation and carburization in high-temperature atmospheres." },
                { title: "Used in heat-intensive processes", desc: "Ideal for heat exchangers, furnace components, and chemical processing equipment." }
              ].map((feature, idx) => (
                  ...
                  <table className="w-full text-sm text-left border-collapse">
                    <tbody>
                      {[
                        ...
                        { label: "UNSPSC Code", value: "N06600, N06625" },
                    ...
                    <table className="w-full text-xs md:text-sm text-center">
                      ...
                      <tbody>
                        {[
                          ...
                          { el: 'Iron', min800: 'Bal', max800: 'Bal', min800H: 'Bal', max800H: 'Bal' }, // Assuming Bal means Balance
