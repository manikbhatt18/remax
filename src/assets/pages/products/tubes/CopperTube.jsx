      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Copper Tubes</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Copper Tubes</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Copper Tubes</h2>
            ...
            <div className="space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Excellent thermal conductivity</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Highly ductile metal tubing</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Used in heat transfer</h3>
                  </div>
               </div>
            </div>
          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500">
                <p>
                  REMAX FORGE & FITTINGS are among the pre-eminent organizations, involved in manufacturers, suppliers, stockists and exporter Copper Tubes. Available in different lengths, thicknesses and sizes, these Copper Tubes are widely demanded by various industries like food & beverage, chemical, petrochemical, pharmaceutical and cosmetics. In addition to this, we provide tailor-made solution for all our offered Copper Tubes as per customers’ requirements.
                </p>
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <table className="w-full text-sm text-left border-collapse">
                    <tbody>
                      {[
                        ...
                        { label: "Value Added Services", value: "Polishing, Bevelling, Honing & Turning, Heatreating & Annealing, Positive Material Identification (PMI)" },
                ...
                <div className="overflow-x-auto rounded-lg border border-slate-200">
                  <table className="w-full text-sm text-left">
                    ...
                    <tbody>
                      {[
                        { name: 'Flat Copper Tube Hot', grade: 'C11000, C12200, C21000', od: 'Width: 10-20mm; Height: 2-4mm', thk: '0.2-0.7mm' },
                        { name: 'Straight Copper Tube', grade: 'C11000 C10200 C12000 C12200', od: '4-219mm', thk: '0.35-5.5mm' },
                        { name: 'Copper Clad Aluminum Tube', grade: 'C11000 copper , 3003 aluminum', od: '6.35-19.05mm', thk: '0.5-1.20mm' },
                        { name: 'LWC Copper Tube Coil/Pancake coil', grade: 'C10200', od: '4-22.23mm', thk: '0.3-1.5mm' },
                        { name: 'Inner Groove Copper Tube NEW', grade: 'C10200 C12200 C26800C27000 etc.', od: '5.0-15.8mm', thk: '0.35-0.83mm' },
                        { name: 'Brass Tube', grade: 'C23000 C24000 C26000 C26200 C27000 C72000 C28000', od: '4-203mm', thk: '0.5-3.5mm' },
                        { name: 'Nickel-Copper Tube', grade: 'C71500 C70600', od: '10-55mm', thk: '0.5-3mm' },
                        { name: 'Copper Tube Coil', grade: 'C11000, C10200, C12200, etc.', od: '4-22.23mm', thk: '0.3-3.5mm' },
                        { name: 'Precision Copper Tube Hot', grade: 'C10200 C12200 C26800 C27200 C27000 etc.', od: '1.6-5mm', thk: '0.27- 2.0mm' },
                        { name: 'OFHC Copper Tube', grade: 'C11000, C12200, C21000', od: '10-40mm', thk: '1-10mm' },
                        { name: 'ETP Copper Tube', grade: 'C11000', od: '4-219mm', thk: '0.35-5.5mm' },
                        { name: 'Insulation Copper Tube Coil Hot', grade: 'C12200', od: '22.35-35mm', thk: '0.3-1.5mm' },
                        { name: 'Aluminum Clad Copper Tube', grade: 'C11000', od: '6.35-19.05mm', thk: '0.5-1.50mm' },
                        { name: 'Condenser Tube', grade: 'C44300 C68700 C70600 C71500', od: '12-50mm', thk: '0.8-3mm' },
                        { name: 'Capillary Copper Tube', grade: 'C10200 C12200 C2680 C27200 C27000 etc.', od: '≥ 0.3mm', thk: '≥ 0.1mm' },
                        { name: 'Oxygen Free Copper Tube', grade: 'C10200', od: '4-25mm', thk: '0.27-2.5mm' }
                      ].map((row, idx) => (
