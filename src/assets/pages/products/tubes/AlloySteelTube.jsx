      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Alloy Steel Tubes</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Alloy Steel Tubes</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Alloy Steel Tubes</h2>
            ...
            <div className="space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Enhanced mechanical performance</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">High temperature pressure service</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Chromium molybdenum alloys</h3>
                  </div>
               </div>
            </div>
          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500">
                <p>
                  REMAX FORGE & FITTINGS are among the pre-eminent organizations, involved in manufacturers, suppliers, stockists and exporter Alloy Steel Tubes. Available in different lengths, thicknesses and sizes, these Alloy Steel Tubes are widely demanded by various industries like food & beverage, chemical, petrochemical, pharmaceutical and cosmetics. In addition to this, we provide tailor-made solution for all our offered Alloy Steel Tubes as per customers’ requirements.
                </p>
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left border-collapse">
                    <tbody>
                      {[
                        { label: "Type", value: "Seamless Tube , EFW Tube" },
                        ...
                        { label: "Range", value: "6.35 mm OD up to 254 mm OD in 0.6 TO 20 mm thickness." },
