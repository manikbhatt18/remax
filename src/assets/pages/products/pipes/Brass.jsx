      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Brass Pipe</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Brass Pipe</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {[
                { title: "Copper-zinc alloy piping", desc: "Offers a combination of strength, corrosion resistance, and formability." },
                { title: "Good machinability and strength", desc: "Easily machined and fabricated, making it suitable for complex components." },
                { title: "Used in valves fittings", desc: "Ideal for decorative, plumbing, and low-friction applications." }
              ].map((feature, idx) => (
          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500">
                <p>
                  REMAX FORGE & FITTINGS are among the pre-eminent organizations, involved in manufacturers, suppliers, stockists and exporter Brass Pipes. Available in different lengths, thicknesses and sizes, these Brass Pipes are widely demanded by various industries like food & beverage, chemical, petrochemical, pharmaceutical and cosmetics. In addition to this, we provide tailor-made solution for all our offered Brass Pipes as per customers’ requirements.
                </p>
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left border-collapse">
                    <tbody>
                      {[
                        { label: "Type", value: "Brass Pipe" },
                        { label: "Standard", value: "ASTM B-111, BS 2871 Part 3, EN 12451, NFA 51 102, JIS H3300" },
                        { label: "Grade", value: "C68700, CZ-110, CuZn20Al2As, CuZn22Al2, C6870" },
