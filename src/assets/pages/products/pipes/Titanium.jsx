      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Titanium Pipe</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Titanium Pipe</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {[
                { title: "Lightweight with high strength", desc: "Offers an exceptional strength-to-density ratio, stronger than some steels but less dense." },
                { title: "Outstanding corrosion resistance", desc: "Highly resistant to sea water, aqua regia, and chlorine." },
                { title: "Ideal for marine environments", desc: "Widely used in desalination plants, offshore oil & gas, and marine components." }
              ].map((feature, idx) => (
                  ...
                  <table className="w-full text-sm text-left border-collapse">
                    <tbody>
                      {[
                        ...
                        { label: "Standards", value: "ASME SB-363, ASME SB-381, ASME SB-337, ASME SB-338, ASME SB-348, ASTM F-67, AMS 4921, ASME SB-265, AMS 4902, AMS 4942" },
