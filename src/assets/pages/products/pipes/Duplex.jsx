      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Duplex / Super Duplex Pipes</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Duplex / Super Duplex Pipes</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {[
                { title: "High strength stainless steel", desc: "Combines the best attributes of both austenitic and ferritic stainless steels." },
                { title: "Excellent stress corrosion resistance", desc: "Superior resistance to chloride stress corrosion cracking." },
                { title: "Ideal for offshore applications", desc: "Widely used in oil & gas exploration and marine environments." }
              ].map((feature, idx) => (
          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500">
                <p>
                  REMAX FORGE & FITTINGS are among the pre-eminent organizations, involved in manufacturers, suppliers, stockists and exporter Duplex Steel Pipe. Available in different lengths, thicknesses and sizes, these Duplex Steel Pipe are widely demanded by various industries like food & beverage, chemical, petrochemical, pharmaceutical and cosmetics. In addition to this, we provide tailor-made solution for all our offered Duplex Steel Pipe as per customers’ requirements.
                </p>
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left border-collapse mb-8">
                    ...
                    <tbody>
                      {[
                        ...
                        { label: "Keyword", value: "Seamless Duplex Stainless Steel Pipe for Petroleum Chemical Industry Specifications" },
                  ...
                  <table className="w-full text-sm text-left border-collapse">
                    <caption className="text-left font-bold text-lg text-[#0F172A] mb-2">Super Duplex Steel</caption>
                    <tbody>
                      {[
                        { label: "Type", value: "Seamless Pipe, Welded Pipe" },
                        { label: "Standards", value: "ASTM A790, ASTM A928" },
                        { label: "Grade", value: "UNS S32750, UNS S32760, SAF 2507" },
                ...
                <div>
                  ...
                  <div className="overflow-x-auto rounded-lg border border-slate-200">
                    <table className="w-full text-sm text-left">
                      ...
                      <tbody>
                        {[
                          { mat: 'Duplex Steel', uts: '95', ys: '65', h: '31 Rockwell C' },
                          { mat: 'Super Duplex Steel', uts: '95', ys: '65', h: '31 Rockwell C' }
                        ].map((row, idx) => (
                          <tr key={idx} className={`border-b border-slate-200 ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                            <td className="px-4 py-2 font-bold text-[#D71920]">{row.mat}</td>
