      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Aluminium Pipe</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Aluminium Pipe</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {[
                { title: "Lightweight corrosion resistant", desc: "Significant weight advantage with excellent natural corrosion resistance." },
                { title: "Easy fabrication and handling", desc: "Ductile and easy to machine, weld, and form." },
                { title: "Good thermal conductivity", desc: "Efficient for heat transfer applications." }
              ].map((feature, idx) => (
          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500">
                <p>
                  REMAX FORGE & FITTINGS are among the pre-eminent organizations, involved in manufacturers, suppliers, stockists and exporter Aluminium Pipe. Available in different lengths, thicknesses and sizes, these Aluminium Pipe are widely demanded by various industries like food & beverage, chemical, petrochemical, pharmaceutical and cosmetics. In addition to this, we provide tailor-made solution for all our offered Aluminium Pipe as per customers’ requirements.
                </p>
                ...
                <p>
                  Aluminium metal is so chemically reactive that native specimens are rare and limited to extreme reducing environments. Instead, it is found combined in over 270 different minerals. The chief ore of aluminium is bauxite. Aluminium is remarkable for the metal's low density and for its ability to resist corrosion due to the phenomenon of passivation. Structural components made from aluminium and its alloys are vital to the aerospace industry and are important in other areas of transportation and structural materials. The most useful compounds of aluminium, at least on a weight basis, are the oxides and sulfates.
                </p>
                <p>
                  ...
                  <table className="w-full text-sm text-left border-collapse">
                    <tbody>
                      {[
                        ...
                        { label: "Standards", value: "ASME SB241, ASTM B210, WWW-T-700/5, ASTM B221, ASTM B241, ASTM B429, AMS-QQ-A-200/8, MIL-DTL-25995 Type A, AMS-QQ-A-200/9" },
                      ...
                      <tbody>
                        {[
                          ...
                          <tr key={idx} className={`border-b border-slate-200 ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                            <td className="px-4 py-2 font-bold text-[#D71920] border-r border-slate-200">{row.comp}</td>
                    ...
                    <table className="w-full text-sm text-left">
                      <thead className="bg-[#0F172A] text-white">
                        <tr>
                          ...
                          <th className="px-4 py-3">Brinell Hardness (500kg, 10mm)</th>
                      ...
                      <tbody>
                        {[
                          ...
                          <tr key={idx} className={`border-b border-slate-200 ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                            ...
                            <td className="px-4 py-2">{row.uts}</td>
                            <td className="px-4 py-2">{row.ps}</td>
                            <td className="px-4 py-2">{row.bh}</td>
                            <td className="px-4 py-2">{row.el}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                    ...
                    <table className="w-full text-sm text-left">
                      ...
                      <tbody>
                        {[
                          ...
                          <tr key={idx} className={`border-b border-slate-200 ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                            <td className="px-4 py-2 font-bold text-[#D71920] border-r border-slate-200">{row.tr}</td>
